...
namespace IssueTracker.Api.Services
{
    ...
    public static class PasswordService
    {
        ...
        private static byte[] HashPassword(string password, RandomNumberGenerator rng, KeyDerivationPrf prf = KeyDerivationPrf.HMACSHA512, int iterCount = IterationCount, int saltSize = 128 / 8, int numBytesRequested = 256 / 8)
        {
